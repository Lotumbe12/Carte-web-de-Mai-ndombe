...
map.getView().fit([1537016.026351, -592081.450552, 2625091.533601, -37286.985682], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte de Mai ndombe</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (48 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'carte web des secteurs d\'activités de mai ndombe';
            }
